    ...
    <section className="px-5 pt-16 pb-12 sm:px-8 sm:pt-20 sm:pb-16">
      <FadeIn className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-5 text-base leading-relaxed text-vycl-text-muted sm:text-lg">
          ...
          knows the dealer conversation, what proof they need, and how to turn a
          demo into a signed agreement backed by a live reference program.
        </p>
      </FadeIn>
    </section>
  );
